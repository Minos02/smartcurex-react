...
const CovidDetection = () => {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:5000/predict/covid', {
        method: 'POST',
        headers: {
      ...
      if (data.success) {
        navigate("/results", {
          state: {
            result: data,
            diseaseType: "COVID-19 Detection",
            patient: { name: formData.name, age: formData.age },
            imagePreview: formData.imagePreview,
            imageFilename: formData.image?.name || 'covid-xray.jpg'
          }
        });
      } else {
    ...
    <div className="disease-page">
      ...
      <div className="disease-content">
        ...
        <section className="details-section">
          <h2>About COVID-19 Detection</h2>
          <div className="details-content">
            <p>
              COVID-19 has impacted millions worldwide. Rapid diagnosis through chest X-ray
              analysis helps in quick patient management.
            </p>
            <p>
              Our model classifies X-rays as Normal, COVID-19, or Pneumonia for comprehensive
