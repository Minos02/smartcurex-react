...
const BrainTumorPage = () => {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:5000/predict/brain-tumor', {
        method: 'POST',
        headers: {
      ...
      if (data.success) {
        navigate("/results", {
          state: {
            result: data,
            diseaseType: "Brain Tumor Classification",
            patient: { name: formData.name, age: formData.age },
            imagePreview: formData.imagePreview,
            imageFilename: formData.image?.name || 'brain-scan.jpg'
          }
        });
      } else {
    ...
    <div className="disease-page">
      ...
      <div className="disease-hero">
        <div className="hero-content">
          ...
          <p>AI-Powered Brain MRI Tumor Classification</p>
        </div>
      </div>
      ...
      <div className="disease-content">
        ...
        <section className="upload-section">
          <h2>Upload Brain MRI Image & Patient Data</h2>
            ...
            <button
              ...
              onMouseEnter={(e) => {
                if (!isAnalyzing) {
                  ...
                  e.target.style.boxShadow = '0 8px 24px rgba(255, 107, 107, 0.5)';
                }
              }}
              onMouseLeave={(e) => {
        ...
        <section className="details-section">
          ...
          <div className="details-content">
            <p>
              Brain tumors are serious medical conditions requiring early detection and classification.
              Our AI model assists in rapid tumor identification.
            </p>
            <p>
              The system classifies tumors into four categories: Glioma, Meningioma, Pituitary, and No Tumor.
            </p>
          </div>
        </section>
      </div>
